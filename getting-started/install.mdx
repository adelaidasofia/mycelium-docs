...
The substrate is the open-source [ai-brain-starter](https://github.com/mycelium-hq/ai-brain-starter) repo. Three install paths, ordered from least to most technical.
...
Read the README at github.com/mycelium-hq/ai-brain-starter and follow it end to end.
```
