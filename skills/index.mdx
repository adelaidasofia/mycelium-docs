...
Skills are the executable layer. Each one is a slash command that the agent runs deterministically against the vault. The list below covers the open-source set in [ai-brain-starter](https://github.com/adelaidasofia/ai-brain-starter).
