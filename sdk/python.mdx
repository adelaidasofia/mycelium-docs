...
The Python surface ships in the open-source [ai-brain-starter](https://github.com/adelaidasofia/ai-brain-starter) repo. The skills under `skills/` are runnable Python: each one reads the vault, calls deterministic services, and writes typed entries.
